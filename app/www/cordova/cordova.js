 ...
 * commands.
 */
var cordova = require('app/www/cordova/cordova'),
...
channel.join(function() {
    ...
    // side.
    channel.join(function() {
        require('app/www/cordova/cordova').fireDocumentEvent('deviceready');
...
window.cordova = require('app/www/cordova/cordova');
